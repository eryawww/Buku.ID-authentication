...
public class UserRepository {
  ...
  private void checkNull(User user) throws InvalidParameterException {
    if (user.getFullname() == null)
      throw new InvalidParameterException("Fullname is Null");
    if (user.getEmail() == null)
      throw new InvalidParameterException("Email is Null");
    if (user.getPhone() == null)
      throw new InvalidParameterException("Phone is Null");
    if (user.getPassword() == null)
      throw new InvalidParameterException("Password is Null");
    if (user.getBio() == null)
      throw new InvalidParameterException("Bio is Null");
    if (user.getGender() == null)
      throw new InvalidParameterException("Gender is Null");
    if (user.getIdUser() == null)
      throw new InvalidParameterException("idUser is Null");
  ...
  private void checkIdUser(User user) throws InvalidParameterException {
    ...
    if (userExists.containsKey(user.getIdUser()))
      throw new InvalidParameterException("User Id collision occur");
  }

  private void checkGender(User user) throws InvalidParameterException {
    if (user.getGender() == null)
      throw new InvalidParameterException("Gender is null");
    if (GenderEnum.contains(user.getGender().toString()))
      throw new InvalidParameterException("Gender is not a valid value");
  }
}